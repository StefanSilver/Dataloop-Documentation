...
- **Active Organization:** As a member of one or more Organizations, users have an "Active Organization". This means they can view the currently active Organization on the left-side menu in the WebUI. If a user belongs to multiple Organizations, they can switch the active Organization by clicking on the Organization name dropdown list and selecting the desired one.
...
[Read more about Organizations here](https://dataloop.ai/docs/org-setup).
